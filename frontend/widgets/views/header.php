            ...
            <form class="navbar-search">
                ...
                <div class="input-group">
                    <input type="text" id="search" class="form-control search-field product-search-field" dir="ltr"
                           value="" name="s" placeholder="Qidirish..."/>
                    <!-- .input-group-addon -->
                                ...
                                <?php if ($category->childCount == 0): ?>
                                    ...
                                    <li class="menu-item animate-dropdown">
                                        <a title="ALL CATEGORIES"
                                           href="<?= \yii\helpers\Url::to(['/product/category', 'id' => $category->id]) ?>"><?= $category->name ?></a>
                                    </li>
                                <?php else: ?>
                                    <!--                                    --><?php //echo 0;die; ?>
                    ...
                    <nav id="handheld-navigation" class="handheld-navigation" aria-label="Handheld Navigation">
                        ...
                        <div class="handheld-navigation-menu">
                            ...
                            <ul id="menu-departments-menu-1" class="nav">
                                ...
                                foreach ($categories as $category): ?>
                                    <li class="highlight menu-item animate-dropdown">
                                        <a title="Value of the Day" href="shop.html"><?= $category->name ?></a>
                                    </li>
                                <?php endforeach; ?>
